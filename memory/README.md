...
Update `PROJECT_STATE.md` whenever an implementation milestone changes. Append
to `EXPERIMENT_LOG.md` for every non-trivial run; do not overwrite old results.
